# User Centric Frontend Development Milestone Project - JJLG
...
### First time visitor
* The purpose of the website should be explicit.
* Smooth navigation through content is key.
* The content of the website should be relevant and concise. 
...
* Javascript shade helped by tutorial https://www.youtube.com/watch?v=Tdkuk9uDTfM&ab_channel=ConorBailey
